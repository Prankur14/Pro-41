class Game {
    ...
    async start() {
        ...
        if (gameState === 0) {
            ...
            textStyle("comfortaa");
            textFont(11);
            text("Control Volume: ", window.innerWidth - 160, window.innerHeight - 180);
    ...
    play() {
        ...
        for (var plr in allPlayers) {
            ...
            // text("Player 1:" + playerIndex.score, 30, 50)
            // text("Player 2:" + playerIndex.score, 30, 70)
            index = index + 1;
            ...
            if (index === player.index) {
                ...
                // text(allPlayers[plr].score, window.innerWidth + 50, window.innerHeight + 30)
